...
class SCScoreTest(unittest.TestCase):
    """Test class for SCScore wrapper"""
    ...
    def setUpClass(cls) -> None:
        ...
        cls.module_url = f"{V2_HOST}:{V2_PORT}/api/scscore"
    ...
    def test_1(self):
        case_file = "tests/wrappers/scscore/scscore_default_test_case_1.json"
