...
class SCScoreBatchTest(unittest.TestCase):
    """Test class for SCScore Batch wrapper"""
    ...
    def setUpClass(cls) -> None:
        ...
        cls.module_url = f"{V2_HOST}:{V2_PORT}/api/scscore/batch"
    ...
    def test_1(self):
        case_file = "tests/wrappers/scscore/scscore_batch_test_case_1.json"
