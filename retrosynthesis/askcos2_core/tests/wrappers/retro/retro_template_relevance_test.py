...
class ForwardWLDN5Test(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.module_url = f"{V2_HOST}:{V2_PORT}/api/retro/template-relevance"
    ...
    def test_1(self):
        case_file = "tests/wrappers/retro/retro_template_relevance_test_case_1.json"
        ...
        for response in [response_sync, response_async]:
            ...
            self.assertIsInstance(response["result"][0]["templates"], list)
            self.assertIsInstance(response["result"][0]["templates"][0], dict)
