...
class ForwardWLDN5Test(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.module_url = f"{V2_HOST}:{V2_PORT}/api/forward/wldn5"
    ...
    def test_1(self):
        case_file = "tests/wrappers/forward/forward_wldn5_test_case_1.json"
        ...
        for response in [response_sync, response_async]:
            ...
            self.assertIsInstance(response["result"][0][0]["outcome"], dict)
            self.assertIsInstance(response["result"][0][0]["outcome"]["smiles"], str)
