...
class ForwardG2STest(unittest.TestCase):
    """Test class for Forward Graph2SMILES wrapper"""
    ...
    def setUpClass(cls) -> None:
        ...
        cls.module_url = f"{V2_HOST}:{V2_PORT}/api/forward/graph2smiles"
    ...
    def test_1(self):
        case_file = "tests/wrappers/forward/forward_graph2smiles_test_case_1.json"
