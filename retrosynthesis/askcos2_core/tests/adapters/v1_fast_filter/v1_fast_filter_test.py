...
class V1FastFilterTest(unittest.TestCase):
    """Test class for V1 fast_filter adapter"""
    ...
    def setUpClass(cls) -> None:
        ...
        cls.v1_fast_filter_url = "https://askcos-demo.mit.edu/api/v2/fast-filter/"
        cls.v1_celery_url = "https://askcos-demo.mit.edu/api/v2/celery/task"
        cls.legacy_adapter_url = f"http://{V2_HOST}:{V2_PORT}/api/legacy/fast-filter/"
    ...
    def test_1(self):
        case_file = "tests/adapters/v1_fast_filter/v1_fast_filter_test_case_1.json"
        with open(case_file, "r") as f:
            data = json.load(f)

        task_ids = {}
        for mode, url in [("v1", self.v1_fast_filter_url),
        ...
        self.assertAlmostEqual(results["v1"]["output"], results["legacy"]["output"], places=7)
